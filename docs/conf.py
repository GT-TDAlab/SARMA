...
latex_documents = [
    (master_doc, 'sarma.tex', 'sarma Documentation',
...
man_pages = [
    (master_doc, 'sarma', 'sarma Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sarma', 'sarma Documentation',
     author, 'sarma', 'One line description of project.',
     'Miscellaneous'),
]
...
github_link = 'https://github.com/GT-TDAlab/SARMA/'
